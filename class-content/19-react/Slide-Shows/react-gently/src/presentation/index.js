    ...
    return (
      ...
      >
        ...
        >
          ...
          <br />
          <Heading size={5}>
            React is one of the most powerful, in demand front end JavaScript
            libraries today.
          </Heading>
        </Slide>
        <Slide
        ...
        >
          ...
          <Heading size={4} style={{ marginTop: "12vh" }}>
            Just About Every Popular UI Library That Came After React Borrows
            From It
          </Heading>
          <br />
          <Heading size={6}>
            Libraries are like fads. They’ll always come and go in popularity,
            but the ideas introduced by React appear to be here to stay.
          </Heading>
        </Slide>
        <Slide
          align="center flex-start"
        ...
        >
          ...
          <List style={{ marginTop: "12vh" }}>
            <ListItem style={{ fontSize: "27pt" }}>
              An open-source JavaScript library developed at Facebook
              specifically for the task of developing user interfaces.
            </ListItem>
            <ListItem style={{ fontSize: "27pt", marginTop: 10 }}>
              Developed for the purpose of building large apps with rapidly
              changing data.
            </ListItem>
            <ListItem style={{ fontSize: "27pt", marginTop: 10 }}>
              Relies on a component-based architecture. Elements of the UI are
              broken into self-contained components.
            </ListItem>
        ...
        >
          ...
          <Underline />
          <Image
            style={{ marginTop: "10vh", width: "80%" }}
            src={images.facebook}
          />
          <Text style={{ fontSize: "16pt" }}>
            Facebook’s website buzzes with interactive options, live-updating
            data, and tightly interacting elements. This poses a challenge to
            simple DOM manipulation strategies.
          </Text>
        </Slide>
        <Slide
          align="center flex-start"
        ...
        >
          ...
          <Image
            ...
            src={images.compExample}
          />
          <Text style={{ fontSize: "16pt" }}>
            Using React, UI elements are broken down into re-usable components.
            Each sub-component behaves in a way that it is fully contained.
          </Text>
        </Slide>
        <Slide
          align="center flex-start"
            ...
            <Fill>
              ...
              <List>
                <ListItem style={{ fontSize: "18pt", marginTop: 5 }}>
                  Components allow us to logically decompose a UI into different
                  parts
                </ListItem>
                <ListItem style={{ fontSize: "18pt", marginTop: 5 }}>
            ...
            <Fill style={{ flex: 1 }}>
              <List>
                <ListItem style={{ fontSize: "14pt" }}>
                  <S type="bold">
                    In jQuery, our application’s state and UI are updated
                    independently of each other.
                  </S>{" "}
                  Without an organization structure, code quickly become a
                  series of erratic DOM manipulations.
                </ListItem>
                <ListItem style={{ fontSize: "14pt", marginTop: 38 }}>
                  In contrast, when working with React, we never update the DOM
                  ourselves. Instead, whenever some part of our application’s
                  state changes, React efficiently updates the DOM for us to
                  reflect this.{" "}
                  <S type="bold">
                    Our application’s UI is a pure function of its state.
                  </S>
                </ListItem>
              </List>
            </Fill>
        ...
        >
          ...
          <Text style={{ marginTop: 20, fontSize: "1.6rem" }}>
            But whenever we update the DOM, the browser needs to recalculate the
            CSS, update the layout, and repaint the web page...
          </Text>
          <Text style={{ marginTop: 20, fontSize: "1.6rem" }}>
        ...
        >
          ...
          <Text style={{ fontSize: "2.44rem" }}>
            React’s Virtual DOM serves as an intermediary and avoids unnecessary
            trips to the DOM
          </Text>
        </Slide>
        <Slide
        ...
        >
          ...
          <Text style={{ fontSize: "2.22rem", marginTop: 15 }}>
            Essentially it’s a JavaScript object that models the real DOM.
            Whenever some part of our application’s state changes, the Virtual
            DOM receives the UI updates first. Then the Virtual DOM is compared
            to the real DOM, which React aims to update with the smallest number
            of changes.
          </Text>
        </Slide>
        <Slide
        ...
        >
          ...
          <Layout>
            <Fill style={{ padding: 10 }}>
              ...
              <List>
                <ListItem style={{ fontSize: "1.44rem" }}>
                  A component-based architecture encourages us to break our
                  application's UI into reusable components, allowing us to
                  build more quickly through code reuse
                </ListItem>
                <ListItem style={{ fontSize: "1.44rem", marginTop: 10 }}>
                  Our application's UI reactively updates in response to changes
                  to its state, reducing the amount of DOM manipulation code we
                  need to write ourselves
                </ListItem>
                <ListItem style={{ fontSize: "1.44rem", marginTop: 10 }}>
                  Can be be used to build applications on the web, on the
                  server, and in native applications
                </ListItem>
                <ListItem style={{ fontSize: "1.44rem", marginTop: 10 }}>
                  Arguably easier to learn and more popular than other competing
            ...
            <Fill style={{ padding: 10 }}>
              ...
              <List>
                <ListItem style={{ fontSize: "1.44rem" }}>
                  React is just a view library concerned with rendering user
                  interfaces. We'll have to pull in other libraries to
                  accomplish things such as HTTP requests
                </ListItem>
                <ListItem style={{ fontSize: "1.44rem", marginTop: 10 }}>
                  Setting up React can require more configuration than other
                  libraries
                </ListItem>
              </List>
            </Fill>
            ...
            <Fill style={{ flex: 3 }}>
              <BlockQuote>
                <Quote style={{ color: "black", fontSize: "16pt" }}>
                  ...
                  applications. When webpack processes your application, it
                  recursively builds a dependency graph that includes every
                  module your application needs, then packages all of those
                  modules into a small number of bundles - often only one - to
                  be loaded by the browser.”
                </Quote>
                <Cite style={{ fontSize: "12pt" }}>From webpack.js.org</Cite>
              </BlockQuote>
              <Text style={{ fontSize: "25pt" }}>
                webpack allows us to us to modularize our front end code in the
                same way we do in Node with CommonJS modules (require,
                module.exports). Also, webpack allows us to apply various
                transformations on our assets through the use of plugins, such
                as…
              </Text>
            </Fill>
          </Layout>
        ...
        >
          ...
          <Underline />
          <Image
            style={{ marginTop: "4vh", width: "70%" }}
            src={images.babel}
          />
          <Text style={{ fontSize: "20pt", marginTop: 15 }}>
            Babel is a JavaScript compiler. It allows us to transform next
            generation JavaScript code (ES6, ES7, ES8) into ES5 JavaScript code
            that most browsers will understand.
          </Text>
          <Text style={{ fontSize: "20pt", marginTop: 15 }}>
            Additionally, developers can extend the JavaScript language syntax
            and create their own features, or even entire languages that compile
            down to regular JavaScript by creating Babel plugins.
          </Text>
          <Text style={{ fontSize: "20pt", marginTop: 15 }}>
            React makes use of both next generation JavaScript, and JavaScript
            syntax extensions.
          </Text>
        </Slide>
        <Slide
        ...
        >
          ...
          <Text style={{ fontSize: "25pt", marginTop: 15 }}>
            There used to be a lot of overhead in setting up a proper React
            application. At times you’d need to have a deep understanding of
            these other libraries to get anything done. This made it hard to get
            started.
          </Text>
          <Text style={{ fontSize: "25pt", marginTop: 15 }}>
            Now, all you need to know is plain old JavaScript. As we’ll soon
            learn, Facebook has since made it REALLY easy to begin working with
            React.
          </Text>
        </Slide>
        <Slide bgColor="primary">
        ...
        >
          ...
          <Text style={{ marginTop: 20 }}>
            Complete each task and answer each of the questions slacked out to
            you.
          </Text>
        </Slide>
        <Slide bgColor="primary">
