...
5. Create a Node/Express/MongoDB/ReactJS app called `nytreact`. This will be a recreation of the [NYT Articles Search](https://nytarticle-search-fsf.herokuapp.com/) exercise application we built back in [Unit 6](./NYTArticleSearch_Best_Solution/). Running this application will:
...
* Deploy your application to Heroku once complete. Feel free to use the [Mern Example](./07-Ins_Mern) as a starting point. **You must use Create React App** and current versions of React and React-Router-Dom for this assignment.
